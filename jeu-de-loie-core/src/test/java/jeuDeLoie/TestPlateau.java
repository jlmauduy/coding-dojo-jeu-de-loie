...
public class TestPlateau {
    ...
    public void testCases() {
        ...
        Map<CaseType, Long> mapCaseType = plateau.getCases().stream().map(Case::getCaseType)
    ...
    @Test
    public void testPlateauAleatoire() {
        Plateau plateau1 = new Plateau();
        Plateau plateau2 = new Plateau();

        assertNotEquals(plateau1.output(), plateau2.output());
    }
